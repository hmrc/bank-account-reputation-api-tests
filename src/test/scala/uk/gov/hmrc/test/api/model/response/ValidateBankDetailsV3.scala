...
case class ValidateBankDetailsV3(
...
object ValidateBankDetailsV3 {
  implicit val responseJsonFormat: OFormat[ValidateBankDetailsV3] = Json.format[ValidateBankDetailsV3]
}
